...
public class InstallShortcutReceiver extends BroadcastReceiver {
    ...
    public static final int INSTALL_SHORTCUT_SUCCESSFUL = 0;
    public static final int INSTALL_SHORTCUT_IS_DUPLICATE = -1;
    public static final int INSTALL_SHORTCUT_NO_SPACE = -2;
    public static final int INSTALL_SHORTCUT_ADD_FAIL = -3;
